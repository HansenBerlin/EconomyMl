...
namespace Models.Business
{
    ...
    public abstract class CompanyBase : ICompanyModel
    {
        ...
        protected readonly ICountryEconomyMarketsModel CountryEconomyMarkets;
        ...
        protected CompanyBase(ICountryEconomyMarketsModel countryEconomyMarkets, ProductController productController,
        ...
        public void ActionProduce()
        {
            ...
            Production.AvailableProductionEnergy -= unitsProduced * Production.EnergyNeededPerPiece;
            Production.AvailableProductionResources -= unitsProduced * Production.ResourceNeededPerPiece;
        }
