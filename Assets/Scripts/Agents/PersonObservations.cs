...
namespace Agents
{
    public class PersonObservations
    {
        ...
        public PersonObservations(int age, decimal desiredSalary, BankAccountModel bankAccount,
            PoliciesWrapper policies, JobMarketController jobMarket, NormalizationController normController)
        {
            ...
            _normController.AddNew(nameof(MonthlyIncomeAccumulatedForYear), NormRange.One,
                (float) MonthlyIncomeAccumulatedForYear);
            _normController.AddNew(nameof(MonthlyExpensesAccumulatedForYear), NormRange.One,
                (float) MonthlyExpensesAccumulatedForYear);
        ...
        public float ObsUnsatisfiedBaseDemand =>
            _normController.Normalize(nameof(UnsatisfiedBaseDemand), UnsatisfiedBaseDemand);
        ...
        public float ObsMonthlyExpensesAccumulatedForYear =>
            _normController.Normalize(nameof(MonthlyExpensesAccumulatedForYear),
                (float) MonthlyExpensesAccumulatedForYear);

        public float ObsMonthlyIncomeAccumulatedForYear =>
            _normController.Normalize(nameof(MonthlyIncomeAccumulatedForYear), (float) MonthlyIncomeAccumulatedForYear);
